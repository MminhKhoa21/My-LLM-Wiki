...
# Track 2: AI Infrastructure & Data (Phase 2)
...
- CI/CD cho AI (LLMOps).
- GPU FinOps & cost management (quản lý chi phí tài nguyên, đặc biệt token cost).
...
- Lakehouse, Vector Store, Feature Store.
- Serving & Scaling (triển khai các model lớn).
- CI/CD cho môi trường AI.
- Observability / LLMOps.
- Governance, GPU management & FinOps.
